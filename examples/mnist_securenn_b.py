...
def train():
  ...
  Wconv2 = weight_variable([KERNEL,
                            ...
                            HIDDEN_CHANNELS,
                            HIDDEN_CHANNELS], 1.)
  bconv2 = bias_variable([1, 1, HIDDEN_CHANNELS])
  ...
  np.save('../examples/test_data/network_b_tf_output_100.npy', pred)

  current_dir = os.getcwd()
  pb_filename = '/test_data/network_b.pb'
  export_to_pb(sess, y, current_dir + pb_filename)
  np_filename = '/test_data/mnist_input_network_b.npy'
